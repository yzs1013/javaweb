        ...
        <el-card shadow="never" body-style="padding: 25px;">
          ...
          <div class="user-info-list">
            <div class="user-info-item">
              <i class="el-icon-user"></i><span>资深JAVA架构师</span>
            </div>
            <div class="user-info-item">
              <i class="el-icon-office-building"></i><span>JavaWeb研发中心 - 架构设计部 - 资深架构师</span>
            </div>
            <div class="user-info-item">
              <i class="el-icon-location-information"></i><span>中国 • 江苏省 • 南京市</span>
            </div>
            <div class="user-info-item">
              <i class="el-icon-_school"></i><span>SpringBoot、MybatisPlus、Shiro、Vue、ElementUI</span>
            </div>
          </div>
            ...
            <el-tab-pane label="账号绑定" name="account">
              <div class="user-account-list">
                ...
                <div class="user-account-item ele-cell">
                  <div class="ele-cell-content">
                    <div>密保邮箱</div>
                    <div class="ele-text-secondary">已绑定邮箱：1175401194@qq.com</div>
                  </div>
                  <el-link type="primary" :underline="false">去修改</el-link>
                </div>
                <el-divider/>
